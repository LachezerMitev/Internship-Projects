...
namespace AutoServiceShop.Business.Processor.VehicleMakeModel
{
    class VehicleMakeModelProcessor : IVehicleMakeModelProcessor
    {
        ...
        {
            Data.Entity.VehicleMakeModel entity = VehicleMakeModelParamConverter.Convert(param);
        ...
        public List<VehicleMakeModelResult> Create(List<VehicleMakeModelParam> param)
        {
            ...
            {
                entities.Add(VehicleMakeModelParamConverter.Convert(item));
            }
        ...
        {
            List<Data.Entity.VehicleMakeModel> accounts = VehicleMakeModelDao.Find();
        ...
        public void Update(long id, VehicleMakeModelParam param)
        {
            ...
            Data.Entity.VehicleMakeModel newEntity = VehicleMakeModelParamConverter.Convert(param);
        ...
        public void Update(List<VehicleMakeModelParam> param)
        {
            ...
            foreach (var item in param)
            {
                ...
                Data.Entity.VehicleMakeModel newEntity = VehicleMakeModelParamConverter.Convert(item);
                VehicleMakeModelDao.Update(newEntity);
            }
        }
    }
