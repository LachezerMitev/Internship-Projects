...
namespace AutoServiceShop.Business.Processor.Employee
{
    class EmployeeProcessor : IEmployeeProcessor
    {
        ...
        {
            Data.Entity.Employee entity = EmployeeParamConverter.Convert(param);
        ...
        public List<EmployeeResult> Create(List<EmployeeParam> param)
        {
            ...
            {
                entities.Add(EmployeeParamConverter.Convert(item));
            }
        ...
        {
            List<Data.Entity.Employee> accounts = EmployeeDao.Find();
        ...
        public void Update(long id, EmployeeParam param)
        {
            ...
            Data.Entity.Employee newEntity = EmployeeParamConverter.Convert(param);
        ...
        public void Update(List<EmployeeParam> param)
        {
            ...
            foreach (var item in param)
            {
                ...
                Data.Entity.Employee newEntity = EmployeeParamConverter.Convert(item);
                EmployeeDao.Update(newEntity);
            }
        }
    }
