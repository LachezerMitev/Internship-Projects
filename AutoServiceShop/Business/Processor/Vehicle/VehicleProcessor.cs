...
namespace AutoServiceShop.Business.Processor.Vehicle
{
    class VehicleProcessor : IVehicleProcessor
    {
        ...
        {
            Data.Entity.Vehicle entity = VehicleParamConverter.Convert(param);
        ...
        public List<VehicleResult> Create(List<VehicleParam> param)
        {
            ...
            {
                entities.Add(VehicleParamConverter.Convert(item));
            }
        ...
        {
            List<Data.Entity.Vehicle> accounts = VehicleDao.Find();
        ...
        public void Update(long id, VehicleParam param)
        {
            ...
            Data.Entity.Vehicle newEntity = VehicleParamConverter.Convert(param);
        ...
        public void Update(List<VehicleParam> param)
        {
            ...
            foreach (var item in param)
            {
                ...
                Data.Entity.Vehicle newEntity = VehicleParamConverter.Convert(item);
                VehicleDao.Update(newEntity);
            }
        }
    }
