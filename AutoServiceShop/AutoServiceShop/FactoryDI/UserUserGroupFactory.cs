...
namespace AutoServiceShop.FactoryDI
{
    public static class UserUserGroupFactory
    {
        ...
        public static Data.Entity.UserUserGroup ResolveEF()
        {
            Builder();
            ...
            {
                var service = scope.Resolve<Data.Entity.UserUserGroup>();

                return service;
            }
        }

        public static Data.Entity.UserUserGroup ResolveFile()
        {
            Builder();
