...
namespace AutoServiceShop.FactoryDI
{
    public static class UserGroupStatusFactory
    {
        ...
        public static Data.Entity.UserGroupStatus ResolveEF()
        {
            Builder();
            ...
            {
                var service = scope.Resolve<Data.Entity.UserGroupStatus>();

                return service;
            }
        }

        public static Data.Entity.UserGroupStatus ResolveFile()
        {
            Builder();
