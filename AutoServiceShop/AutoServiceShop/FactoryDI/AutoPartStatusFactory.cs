...
namespace AutoServiceShop.FactoryDI
{
    public static class AutoPartStatusFactory
    {
        ...
        public static Data.Entity.AutoPartStatus ResolveEF()
        {
            Builder();
            ...
            {
                var service = scope.Resolve<Data.Entity.AutoPartStatus>();

                return service;
            }
        }

        public static Data.Entity.AutoPartStatus ResolveFile()
        {
            Builder();
