...
namespace AutoServiceShop.Business.Processor.AccountType
{
    ...
    {
        public AccountTypeProcessor(IAccountTypeDao dao, IAccountTypeParamConverter paramConverter, IAccountTypeResultConverter resultConverter) : base(dao, paramConverter, resultConverter)
        {
        }
    }
}
