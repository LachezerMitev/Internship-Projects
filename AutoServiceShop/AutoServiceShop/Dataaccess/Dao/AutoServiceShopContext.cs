...
namespace AutoServiceShop.Dataaccess.Dao
{
    ...
    {
        public AutoServiceShopContext(DbContextOptions<AutoServiceShopContext> options) : base(options)
        {
        }

        //migrationBuilder.Sql(File.ReadAllText("../AutoServiceShop/Dataaccess/Dao/SQLSeedData.sql"));
        ...
        public DbSet<Data.Entity.SessionAPI> Sessions { get; set; }
