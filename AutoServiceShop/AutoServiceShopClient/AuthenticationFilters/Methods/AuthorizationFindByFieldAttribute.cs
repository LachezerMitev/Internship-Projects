...
{
    public class AuthorizationFindByField : ActionFilterAttribute
    {
        public override void OnActionExecuting(ActionExecutingContext context)
        {
            string roles = Startup.StaticConfig.GetSection("AuthorizationMethods").GetSection("FindByField").Value;
