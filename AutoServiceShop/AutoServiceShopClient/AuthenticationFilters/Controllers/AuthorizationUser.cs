...
namespace AutoServiceShopClient.AuthorizationAttributes.Controllers
{
    public class AuthorizationUser : ActionFilterAttribute
    {
        public override void OnActionExecuting(ActionExecutingContext context)
        {
            string roles = Startup.StaticConfig.GetSection("AuthorizationControllers").GetSection("User").Value;
